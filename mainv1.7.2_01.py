...
def makeOrder():
    ...
    names = ['Valério', 'Ednalva', 'CJ', 'Big Smoke', 'Walter White', 'Jesse Pinkman', 'Davi', 'João', 'Samuel', 'Gabriel', 'Carlos Eduardo', 'Romero', 'Roana']
    ing = [0, 0, 0, 0]
...
,                                                                                                                                                               
\n""")
print("\033[1;36mSmokin' Burgers: Simulador de hamburgueria\033[m\n")
print(f"\033[1;32m{'Por Davi e Gabriel S.':^42}\033[m\n\n")
input(f"{'>> JOGAR <<':^42}")
